...
//========================================================================================
	...
	// TODO Create a Flux for reading all users from the blocking repository deferred
	//  until the flux is subscribed, and run it with an elastic scheduler
	Flux<User> blockingRepositoryToFlux(BlockingRepository<User> repository) {
		Flux<User> usersReading =  Flux.defer(
...
//========================================================================================
	...
	Mono<Void> fluxToBlockingRepository(Flux<User> flux, BlockingRepository<User> repository) {
		Mono<Void> userContained = flux.publishOn(Schedulers.elastic())
