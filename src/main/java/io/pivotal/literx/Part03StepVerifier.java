...
//========================================================================================
	...
	void expectFooBarError(Flux<String> flux) {
		StepVerifier.create(Flux.just("foo","bar")).expectError(RuntimeException.class);
	}
...
//========================================================================================
	...
	void expectSkylerJesseComplete(Flux<User> flux) {
		StepVerifier.create(flux)
				.assertNext(userName -> assertThat(userName.getUsername()).isEqualTo("swhite"))
				.assertNext(userName -> assertThat(userName.getUsername()).isEqualTo("jpinkman"))
				.verifyComplete();
	}
